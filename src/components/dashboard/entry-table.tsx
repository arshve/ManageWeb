...
// Heavy dialogs lazy-loaded — only fetched when the user opens them.
const LivestockSwapDialog = dynamic(
  () => import('./livestock-swap-dialog').then((m) => m.LivestockSwapDialog),
  { ssr: false, loading: () => null },
);
const BatchEditDialog = dynamic(
  () => import('./batch-edit-dialog').then((m) => m.BatchEditDialog),
  { ssr: false, loading: () => null },
);
